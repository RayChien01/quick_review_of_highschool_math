...
\begin{document}
    ...
    \subsection{Percentiles}
        ...
        \[r = \frac{1}{n}\sum_{i = 1}^{n} x_i'y_i' = \frac{S_{xy}}{\sqrt{S_{xx}}\sqrt{S_{xy}}}\]
    ...
    \section{Additional Tricks}
        ...
        \subsection{The Pairing Method}
            ...
            While dividing some labeled items into groups of two, pick the partners for the unpaired items. For example, the numbers of ways to pair 5 people and one people left is $C^5_1 \times 3 \times 1 = 15.$
        ...
        \subsection{Stewart's Theorem}
            ...
            When the dividing line is a bisector, $z^2 = xy - mn$.

            When it is a median, $2(z^2+n^2) = x^2 + y^2.$
